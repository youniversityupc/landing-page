...
export const AboutUsSection: SectionComponent = (props) => {
  ...
  return (
    <section
      ...
      className={clsx(
        className,
        "flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 py-16"
      )}
    >
      <div className="w-full md:w-1/2 flex justify-center items-center px-4 sm:px-8 lg:px-16">
        <img src="/you-team.png" alt="YOUniversity team picture" />
      </div>
      <div className="w-full md:w-1/2 flex flex-col justify-center items-start space-y-4 px-4">
        ...
        <span className="text-lg sm:text-xl">
          Usamos nuestros conocimientos tecnológicos para innovar y crear nuevos
          proyectos útiles para nuestras comunidades.
        </span>
